...
// // Business Components
// const Denim = lazy(() => import("../components/BusinessComponents/Denim"));
// const Knitwear = lazy(() => import("../components/BusinessComponents/Knitwear"));
// const Kidswear = lazy(() => import("../components/BusinessComponents/Kidswear"));
// const Woven = lazy(() => import("../components/BusinessComponents/Woven"));
// const Sweater = lazy(() => import("../components/BusinessComponents/Sweater"));
// const Chinos = lazy(() => import("../components/BusinessComponents/Chinos"));
// const Intimatewear = lazy(() => import("../components/BusinessComponents/Intimatewear"));
...
//     <>
//       <Helmet>
//         <title>Business Areas | Cotton World Sourcing</title>
//         <meta name="description" content="Explore the diverse business areas of Cotton World Sourcing, including apparel sourcing, textile manufacturing, and sustainability consulting. Learn how we deliver excellence in every stitch." />
//         <meta name="keywords" content="Cotton World Sourcing, apparel sourcing, textile manufacturing, sustainability consulting, fashion, garments" />
//       </Helmet>
//       <Navbar />
//       {/* Hero section for business */}
//       <section className="relative h-[90vh] overflow-hidden text-gray-700 bg-slate-200 font-dmSerifText">
...
//             backgroundImage: "url('/businessPage/hero5.webp')",
//           }}
//           aria-label="Background image of fashion and textiles"
//         />
//         {/* Gradient Overlay */}
//         <div className="absolute inset-0 z-0 bg-gradient-to-br from-slate/70 to-gray/90" />
//         {/* Hero Content */}
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Explore the diverse business areas of Cotton World Sourcing, including apparel sourcing, textile manufacturing, and sustainability consulting. Learn how we deliver excellence in every stitch."
        />
        <meta
          name="keywords"
          content="Cotton World Sourcing, apparel sourcing, textile manufacturing, sustainability consulting, fashion, garments"
        />
        <link rel="canonical" href="https://yourdomain.com/business" />
      </Helmet>
              ...
              >
                <div className="flex justify-center w-full md:w-1/2">
                  <div className="overflow-hidden shadow-xl aspect-[3/4] w-full max-w-[320px] rounded-2xl">
                    <img
                      src={area.image}
                      alt={area.title + " - Cotton World Sourcing"}
                      className="object-cover w-full h-full transition-transform duration-500 transform rounded-2xl hover:scale-105"
                      loading="lazy"
                    />
                  </div>
      ...
      <section id="denim">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Denim...</div>}>
          <Denim />
        </Suspense>
      </section>
      <section id="knitwear">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Knitwear...</div>}>
          <Knitwear />
        </Suspense>
      </section>
      <section id="kidswear">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Kidswear...</div>}>
          <Kidswear />
        </Suspense>
      </section>
      <section id="chinos">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Chinos...</div>}>
          <Chinos />
        </Suspense>
      </section>
      <section id="woven" style={{ scrollMarginTop: "100px" }}>
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Woven...</div>}>
          <Woven />
        </Suspense>
      </section>
      <section id="sweater">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Sweater...</div>}>
          <Sweater />
        </Suspense>
      </section>
      <section id="intimatewear">
        <Suspense fallback={<div className="py-10 text-center text-slate-500">Loading Intimatewear...</div>}>
          <Intimatewear />
        </Suspense>
      </section>
